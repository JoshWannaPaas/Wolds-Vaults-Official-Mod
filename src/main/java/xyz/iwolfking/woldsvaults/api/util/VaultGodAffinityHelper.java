...
<<<<<<< HEAD:src/main/java/xyz/iwolfking/woldsvaults/api/helper/VaultGodAffinityHelper.java
        System.out.println(affinity);
=======
>>>>>>> upstream/master:src/main/java/xyz/iwolfking/woldsvaults/api/util/VaultGodAffinityHelper.java
        return affinity;
    }
