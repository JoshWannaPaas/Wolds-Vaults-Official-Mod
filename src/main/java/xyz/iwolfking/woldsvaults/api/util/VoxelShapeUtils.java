...
/*
 * From: https://github.com/mekanism/Mekanism/blob/1.18.x/src/main/java/mekanism/common/util/VoxelShapeUtils.java
 * Original author: Aidan C. Brady
...
public final class VoxelShapeUtils {
    ...
    public static void print(double x1, double y1, double z1, double x2, double y2, double z2) {
        WoldsVaults.LOGGER.info("box({}, {}, {}, {}, {}, {}),", Math.min(x1, x2), Math.min(y1, y2), Math.min(z1, z2),
                Math.max(x1, x2), Math.max(y1, y2), Math.max(z1, z2));
    }

    /**
     * Creates a simple box with the given parameters
     */
    ...
    public static void printSimplified(String name, VoxelShape shape) {
        WoldsVaults.LOGGER.info("Simplified: {}", name);
